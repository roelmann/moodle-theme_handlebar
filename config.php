...
$THEME->scss = function($theme) {
    return theme_handlebar_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_handlebar_css_tree_post_processor';
$THEME->prescsscallback = 'theme_handlebar_get_pre_scss';
$THEME->extrascsscallback = 'theme_handlebar_get_extra_scss';
