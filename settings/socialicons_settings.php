...
$page = new admin_settingpage('theme_handlebar_social', get_string('socialheading', 'theme_handlebar'));
$page->add(new admin_setting_heading('theme_handlebar_social', get_string('socialheadingsub', 'theme_handlebar'),
        format_text(get_string('socialdesc' , 'theme_handlebar'), FORMAT_MARKDOWN)));

// Website url setting.
$name = 'theme_handlebar/website';
...
// Blog url setting.
$name = 'theme_handlebar/blog';
$title = get_string('blog', 'theme_handlebar');
$description = get_string('blogdesc', 'theme_handlebar');
$default = '';
...
// Google+ url setting.
$name = 'theme_handlebar/googleplus';
...
$name = 'theme_handlebar/pinterest';
...
$name = 'theme_handlebar/instagram';
...
$name = 'theme_handlebar/socialicon1';
$title = get_string('sociallinkicon', 'theme_handlebar');
$description = get_string('sociallinkicondesc', 'theme_handlebar');
$default = 'home';
$setting = new admin_setting_configtext($name, $title, $description, $default);
$page->add($setting);

// General social url setting 2.
$name = 'theme_handlebar/social2';
$title = get_string('sociallink', 'theme_handlebar');
$description = get_string('sociallinkdesc', 'theme_handlebar');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default, PARAM_URL);
...
$name = 'theme_handlebar/socialicon2';
$title = get_string('sociallinkicon', 'theme_handlebar');
$description = get_string('sociallinkicondesc', 'theme_handlebar');
$default = 'home';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_handlebar/socialicon3';
$title = get_string('sociallinkicon', 'theme_handlebar');
$description = get_string('sociallinkicondesc', 'theme_handlebar');
$default = 'home';
$setting = new admin_setting_configtext($name, $title, $description, $default);
